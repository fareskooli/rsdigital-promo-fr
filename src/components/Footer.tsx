...
const Footer = () => {
  return (
    <footer className="border-t border-border/50 bg-card/80 py-12">
      <div className="container mx-auto px-6">
        <div className="grid gap-8 md:grid-cols-3">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="font-semibold text-foreground mb-4 font-[var(--font-heading)]">Contact</h4>
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li>
                <a href="tel:+212600000000" className="flex items-center gap-2 hover:text-primary transition-colors">
                  <Phone className="h-4 w-4 text-primary" />
                  +212 6 00 00 00 00
                </a>
              </li>
              <li>
                <a href="mailto:rsdigital049@gmail.com" className="flex items-center gap-2 hover:text-primary transition-colors">
                  <Mail className="h-4 w-4 text-primary" />
                  rsdigital049@gmail.com
                </a>
              </li>
              <li>
                <a
                  href="https://maps.app.goo.gl/8FpUX2wxqwaK96FK9"
                  target="_blank"
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-lg bg-green-500/10 px-4 py-2 text-sm font-medium text-green-600 hover:bg-green-500/20 transition-colors"
              >
